...
public class TblMachineOprStatesDtls {
	 ...
	 * @param timeOnly
	 */
	public TblMachineOprStatesDtls(int machineID, int oldMachineOperationStatusID, int newMachineOperationStatusID,
	 ...
	 * @param userName
	 */
	public TblMachineOprStatesDtls(String machineCodeName, int oldMachineOperationStatusID, int newMachineOperationStatusID,
