...
public class DaoCustomerOrder {
	...
	public ArrayList<TblCustomerOrder> getAllCustomerOrderByStockID(int stockID ) throws SQLException {
		...
		final String getListOfAllCustomerOrderQuery = """
				...
				custOrder.OrderQty AS OrderQty, custOrder.OnhandQty AS OnHandQty, custOrder.AllocatedQty AS AllocatedQty, custOrder.CustomerNotes AS CustNotes, custOrder.OrderDate AS OrderDate, custOrder.ExpectedDlvryDte AS ExpDeliveryDate
