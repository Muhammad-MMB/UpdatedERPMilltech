...
UserCustomColors(Color c) {
  _myColor = c;
}

UserCustomColors(int r, int g, int b) {
  _myColor = new Color(r, g, b);
}

UserCustomColors(int r, int g, int b, int alpha) {
  _myColor = new Color(r, g, b, alpha);
}

UserCustomColors(float r, float g, float b, float alpha) {
  _myColor = new Color(r, g, b, alpha);
}
